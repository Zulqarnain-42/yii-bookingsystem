...
<div class="container mx-auto mt-10">
    ...
    <?php if (Yii::app()->user->getState('role') === 'admin'): ?>
        ...
        <button onclick="openModal()" class="bg-blue-500 text-white px-4 py-2 rounded">Add Appointment</button>
    <?php endif; ?>
    <!-- Modal -->
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white rounded shadow-lg p-6 w-1/3">
                ...
                <form id="service-form" enctype="multipart/form-data">
                    ...
                    <input type="text" name="appointments[name]" class="w-full border p-2 mb-4">

                    <label class="block mb-2">Description</label>
                    <textarea name="appointments[description]" class="w-full border p-2 mb-4"></textarea>
